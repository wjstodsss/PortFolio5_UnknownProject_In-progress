...
import com.unknown.paldak.admin.service.StockInfoServiceImpl;
...
public class StockLogController {
	...
	private final StockInfoServiceImpl stockInfoServiceUtil;
	...
	public String descList(Criteria cri, Model model) {
		...
		List<StockInfoVO> list = stockInfoServiceUtil.getLogDescList(cri);
    ...
    public ResponseEntity<Map<String, Object>> get(@PathVariable("stockOrderId") long stockOrderId) {
        ...
        if (stockInfo != null) {
            ...
            System.out.println("발주 신청한게 없어 " + stockOrderId);
