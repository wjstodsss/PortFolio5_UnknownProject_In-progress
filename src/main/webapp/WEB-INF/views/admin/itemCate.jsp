...
<%@include file="includes/leftNav.jsp"%>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-cateName" id="cartModalLabel">구매 후기 등록</h5>
	...
	<div class="modal" id="formModal2" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-cateName" id="cartModalLabel">브랜드 수정</h5>
					<button type="button" class="close" aria-label="Close"
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label>상위카테고리ID</label> <input class="form-control" name='cateParent' id='cateParent'>
					</div>
...
function goToDetailModalForm(element) {
	...
	$.ajax({
		...
		success: function(itemCateData) {
			...
			$("#cateParent").text(itemCateData.cateParent);			
